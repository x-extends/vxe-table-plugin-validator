import { VXETableCore, VxeTableDefines, VxeFormDefines, VxeGlobalValidatorsHandles } from 'vxe-table'
...
function createVaildRule (checkMethod: (value: any, rule: VxeTableDefines.ValidatorRule | VxeFormDefines.FormRule) => any) {
